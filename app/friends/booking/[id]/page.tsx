    ...
    return (
      <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white border border-neutral-200 rounded-lg p-6 text-center">
          ...
          <h1 className="font-mono text-xl text-neutral-800 mb-2">
            Booking Not Found
          </h1>
      ...
      <div className="relative max-w-lg mx-auto px-6 py-16">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-3 font-mono text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-neutral-800">
                ${(booking.nights * booking.nightlyRate).toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between">
        ...
        {booking.status === "confirmed" && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <h3 className="font-mono text-lg text-green-800 mb-2">
              You're All Set!
            </h3>
            <p className="font-mono text-sm text-green-700">
              Your booking is confirmed. We'll send arrival instructions closer
