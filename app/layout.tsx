...
export const metadata: Metadata = {
  title:
    "Casa Vistas at Mar Vista | Luxury Ocean-View Rental in Brasilito, Costa Rica",
  description:
  ...
  openGraph: {
    ...
    description:
      "Experience paradise at Casa Vistas with breathtaking ocean views, private infinity pool, and world-class amenities in Brasilito, Costa Rica.",
  ...
  twitter: {
    ...
    title: "Casa Vistas at Mar Vista | Luxury Ocean-View Rental",
    description:
      "Experience paradise at Casa Vistas with breathtaking ocean views and private infinity pool in Costa Rica.",
  },
  robots: {
    index: true,
    follow: true,
