      ...
      <div className="relative max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-center text-white mb-8">
          ...
          <p className="text-5xl font-bold mb-1">
            {bookingData.discountPercent}% OFF
          </p>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8">
          <p className="text-amber-800 text-sm">
            <strong>Important:</strong> This link can only be used once. After
            clicking below, you'll be taken to our booking partner to complete
            payment. Make sure to enter your promo code{" "}
        ...
        <p className="text-center text-xs text-neutral-500 mt-4">
          You'll be redirected to Blue Zone Experience for secure payment
          processing
        </p>
      </div>
    </div>
