...
export default function SeasonalPage() {
  const [availability, setAvailability] = useState<Map<string, DayInfo>>(
    new Map(),
  );
    ...
    const fetchAvailability = async () => {
      ...
      try {
        const response = await fetch(
          `/api/calendar?from=${startDate}&to=${endDate}`,
        );
        if (response.ok) {
  ...
  const isDateSelected = (date: Date) => {
    ...
    if (selectedDates.checkOut && dateStr === selectedDates.checkOut)
      return true;
    if (
      selectedDates.checkOut &&
      dateStr > selectedDates.checkIn &&
      dateStr < selectedDates.checkOut
    )
      return true;
    return false;
  };
      ...
      <div className="min-h-screen bg-[#faf8f5] pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-neutral-600 text-lg mb-4">
            ...
            <strong>{selectedDates.checkIn}</strong> to{" "}
            <strong>{selectedDates.checkOut}</strong>.
          </p>
          <p className="text-neutral-500 mb-8">
            We'll review your request and get back to you within 24 hours with a
            personalized discount code if we think you'd be a great fit for Casa
            Vistas.
          </p>
          <Link
            href="/"
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 text-lg max-w-2xl mx-auto">
            We offer special rates to guests who we trust will treat our home
            with care.
          </p>
        </div>
        ...
        <div className="bg-white/60 border border-neutral-200 rounded-2xl p-6 md:p-8 mb-12">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-neutral-600 text-sm leading-relaxed">
                Casa Vistas is our family's home in Costa Rica — not an
                investment property. We care deeply about it and everyone who
                stays there.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm text-neutral-600">
            <p>
              Like{" "}
              <a
                href="https://www.livekindred.com"
                target="_blank"
              ...
              home exchange, we believe the best guests are those who treat a
              home as if it were their own. We're not looking for the highest
              price — we're looking for people who will appreciate and respect
              what we've built.
            </p>
            <p>
              <strong className="text-neutral-800">Here's the deal:</strong>{" "}
              Tell us a bit about yourself and your party. If we feel confident
              you'll care for our home, we'll send you a personalized discount
              code — anywhere from 20% to 50% off depending on dates and fit.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-neutral-200 p-6">
            ...
            {selectedDates.checkIn && (
              <div className="mt-4 p-4 bg-primary/5 rounded-lg space-y-3">
                ...
                {selectedDates.checkOut &&
                  (() => {
                    const checkInSeason = getSeasonType(
                      new Date(selectedDates.checkIn),
                    );
                    const checkOutSeason = getSeasonType(
                    ...
                    return (
                      ...
                      >
                        {isMixed ? (
                          <span>
                            ⚠️ Your dates span both seasons. We'll discuss
                            pricing options.
                          </span>
                        ) : checkInSeason === "high" ? (
                          <span>
                            ☀️ High Season — We'll send you a discount code (up
                            to 50% off) after approval
                          </span>
                        ) : (
                          <span>
                            💙 Off-Season — Direct booking at $143/night friends
                            rate
                          </span>
                        )}
                      </div>
          ...
          >
            ...
            <p className="text-sm text-neutral-500 mb-6">
              Help us get to know you. The more context you share, the better we
              can tailor your discount.
            </p>
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-neutral-500 mt-1">
                Helps us understand who you are — increases your chances of a
                higher discount
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-neutral-500 mt-1">
                We love families, remote workers, anniversary trips, and anyone
                who appreciates a beautiful home
              </p>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={
              isSubmitting || !selectedDates.checkIn || !selectedDates.checkOut
            }
          ...
          <p className="text-center text-xs text-neutral-500">
            We'll review your request and respond within 24 hours. Your
