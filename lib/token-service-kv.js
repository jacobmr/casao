...
import {
  getCachedToken as getTokenFromCache,
  setCachedToken as setTokenInCache,
} from "./kv-cache";
...
async function fetchNewToken() {
  ...
  const tokenUrl =
    process.env.GUESTY_OAUTH_TOKEN_URL ||
  ...
  console.log(
    "⚠️  ⚠️  ⚠️  FETCHING NEW TOKEN FROM GUESTY (Rate limit: 3/24h) ⚠️  ⚠️  ⚠️",
  );
